...
public class program {    
    ...
    public static void main(String[] args) {
        ...
        do {
            System.out.println("Enter 1 to create Manufacturer \n Enter 2 to create Customer\n Enter 3 to create Product(as well as the manufacturer)\n Enter 4 to create Shop/Warehouse(as well as the inventory)\n Enter 5 to create Delivery Agent \n Enter any other number to skip.");
            switch(sc.nextInt()) {
                case 1:
            ...
            System.out.println("Enter 1 to print all Manufacturers \n Enter 2 to print all Customers \n Enter 3 to print all Products\n Enter 4 to print all Shops/Warehouses \n Enter 5 to print all Delivery Agents \n Enter any other number to skip.");
            switch(sc.nextInt()) {
                case 1:
                    manufacturer.print_all();
                    break;
